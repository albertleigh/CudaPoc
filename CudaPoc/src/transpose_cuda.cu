...
template void transpose<float>(float* output, const float* input, int rows, int cols, dim3 grid_dim, dim3 block_dim);

template void transpose<double>(double* output, const double* input, int rows, int cols, dim3 grid_dim, dim3 block_dim);
...
// Explicit template instantiations
template void transpose_v2<float>(float* output, const float* input, int rows, int cols, dim3 grid_dim, dim3 block_dim);
}  // namespace cuda_poc
