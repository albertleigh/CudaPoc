...
template void vector_sum_v2<float>(float* result,
                                   float* input,
                                   size_t n,
                                   dim3 grid,
                                   dim3 block,
...
template void vector_sum_v3<float>(float* result,
                                   float* input,
                                   size_t n,
                                   dim3 grid,
                                   dim3 block,
...
template void vector_sum_v4<float>(float* result,
                                   float* input,
                                   size_t n,
                                   dim3 grid,
                                   dim3 block,
...
template void vector_sum_v5<float>(float* result,
                                   float* input,
                                   size_t n,
                                   dim3 grid,
                                   dim3 block,
...
template <typename T>
__global__ void sum_kernel_v6_intra_wrap_dual_hardware_loop(T* result,
                                                            const T* input,
                                                            size_t n,
                                                            unsigned int wrap_size) {
  const size_t tid = threadIdx.x;
...
template void vector_sum_v6<float>(float* result,
                                   float* input,
                                   size_t n,
                                   dim3 grid,
                                   dim3 block,
...
template <typename T>
__global__ void sum_kernel_v7_reduce_intra_wrap_shuffle(T* result, const T* input, size_t n, unsigned int wrap_size) {
  extern __shared__ T smem[];
  const size_t tid = threadIdx.x;
...
template void vector_sum_v7<float>(float* result,
                                   float* input,
                                   size_t n,
                                   dim3 grid,
                                   dim3 block,
...
template <typename T>
__global__ void sum_kernel_v8_shuffle_first_pass(T* intermediate, const T* input, size_t n, unsigned int wrap_size) {
  extern __shared__ T smem[];
...
template <typename T>
__global__ void sum_kernel_v8_shuffle_second_pass(T* result, const T* intermediate, size_t n, unsigned int wrap_size) {
  extern __shared__ T smem[];
  size_t tid = threadIdx.x;
...
template void vector_sum_v8<float>(float* result,
                                   float* input,
                                   size_t n,
                                   dim3 grid,
                                   dim3 block,
...
void vector_sum_v9(T* result, T* input, size_t n, dim3 grid, dim3 block, unsigned int wrap_size) {
  ...
  CUDA_CHECK(cudaOccupancyMaxActiveBlocksPerMultiprocessor(&grid_size, sum_kernel_v9_reduce_cooperative<T>, block_size,
                                                           smem_size));
  ...
  CUDA_CHECK(cudaLaunchCooperativeKernel((void*)sum_kernel_v9_reduce_cooperative<T>, grid_size, block, kernelArgs,
                                         smem_size, 0));
...
template void vector_sum_v9<float>(float* result,
                                   float* input,
                                   size_t n,
                                   dim3 grid,
                                   dim3 block,
